    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="pt-32 pb-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          <div className="inline-flex items-center gap-2 mb-6 px-4 py-2 rounded-full bg-secondary/50 border border-border">
            ...
            <span className="text-sm text-muted-foreground">Built on Midnight Blockchain</span>
          </div>
          ...
          <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto leading-relaxed">
            Exercise your "Right to Be Forgotten" with one click. See everywhere your data lives. Delete it all
            instantly with cryptographic proof.
          </p>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 border-t border-border">
        <div className="max-w-6xl mx-auto">
          ...
          <p className="text-center text-muted-foreground text-lg mb-16">GDPR compliance that actually works</p>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="p-8 rounded-lg bg-secondary/30 border border-border">
              ...
              <h3 className="text-2xl font-semibold text-foreground mb-3">Your Personal Data Dashboard</h3>
              <p className="text-muted-foreground mb-6">
                See everywhere your data lives in real-time. One click deletes from ALL services simultaneously. Get
                cryptographic blockchain proof forever.
              </p>
            ...
            <div className="p-8 rounded-lg bg-secondary/30 border border-border">
              ...
              <h3 className="text-2xl font-semibold text-foreground mb-3">Automatic Compliance for Companies</h3>
              <p className="text-muted-foreground mb-6">
                Install SDK like Google Analytics, zero blockchain knowledge needed. Auto-deletion proofs, no more
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 border-t border-border">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-4xl md:text-5xl font-semibold text-foreground mb-16 text-center">How It Works</h2>

          <div className="space-y-8">
            {[
              { step: "1", title: "User signs up for service", desc: "Automatically registers in dashboard" },
              { step: "2", title: "See your data footprint", desc: "Real-time view of all services holding data" },
              { step: "3", title: "One-click deletion", desc: "Data erased from all services in 10-15 seconds" },
              {
                step: "4",
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 border-t border-border">
        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-2 gap-12">
            <div>
              <h3 className="text-3xl font-semibold text-foreground mb-6">€42.57B</h3>
              <p className="text-muted-foreground">European blockchain market blocked by GDPR</p>
            </div>
            <div>
              <h3 className="text-3xl font-semibold text-primary mb-6">€20M</h3>
              <p className="text-muted-foreground">Maximum GDPR fine or 4% of annual revenue</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 border-t border-border">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-muted-foreground text-lg mb-12">Free for users, €500/month for companies</p>
